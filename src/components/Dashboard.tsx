        ...
        <section className="stats-section">
            ...
            <div className="stats-row">
                <div className="stat-card">
                    ...
                    <div className="stat-card-value">{formatCurrency(displayStats.totalInvested)}</div>
                </div>
                <div className="stat-card">
                    <div className="stat-card-label">Total Gain/Loss</div>
                    <div className="stat-card-value" style={{ color: isPositive ? 'var(--accent-green)' : 'var(--accent-red)' }}>
            ...
            {isFiltered && (
                <div className="stats-row" style={{ marginTop: 'var(--space-md)' }}>
                    <div className="stat-card">
                        ...
                        <div className="stat-card-value">{formatCurrency(totalStats.totalValue)}</div>
                    </div>
                    <div className="stat-card">
