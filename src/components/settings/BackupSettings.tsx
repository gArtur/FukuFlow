            ...
            <div className="settings-group-card">
                <div className="data-row">
                    <div className="data-block">
                        ...
                        <button onClick={handleBackup} className="btn-data-action" data-testid="backup-download-btn">
                            Backup Data
                    ...
                    <div className="data-block">
                        ...
                        <button onClick={onShowRestoreModal} className="btn-data-action" data-testid="restore-data-btn">
                            Restore Data
                            <span className="icon-right">↑</span>
                        </button>
                    </div>
